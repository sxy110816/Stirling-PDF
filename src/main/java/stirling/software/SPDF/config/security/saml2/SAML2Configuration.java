    ...
    public OpenSaml4AuthenticationRequestResolver authenticationRequestResolver(
        ...
        resolver.setAuthnRequestCustomizer(
                customizer -> {
                    ...
                    //                    Audience audience =
                    //                            new
                    // AudienceBuilder().buildObject(Audience.DEFAULT_ELEMENT_NAME);
                    ...
                    //                            new
                    // ConditionsBuilder().buildObject(Conditions.DEFAULT_ELEMENT_NAME);
                    //
                    //                    Instant notBefore = Instant.now();
                    //                    conditions.setNotBefore(notBefore);
                    //                    conditions.setNotOnOrAfter(notBefore.plus(10,
                    // ChronoUnit.MINUTES));
                    //
